        ...
        <div class="row">
            <div class="col-12">
                ...
                <p class="fs-5">
                    ...
                    repair. Please note, if you work in the Liverpool
                    Street area, we can offer a <span style="color: red; font-weight: 700">FREE COLLECTION from your
                        office</span> – please get in touch to arrange this.
                </p>
                <p class="fs-5">Here’s the details you need:</p>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style=" font-weight: 600">{{ $data['repair_detail']['device'] }}
                                ...
                                {{ array_key_exists('emc', $data) ? $data['emc'] : '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style=""><strong>No-Fix, No-Fee </strong>
                                </span>promise, there’s nothing to pay for the work undertaken.
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="mb-3 col-12">
                <h5 class="m-0"><b>Surgery Options:</b></h5>
                <table class="table table-bordered table-sm border-dark" style="font-size: 1.2rem;">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td style="width: 180px;">Clinic Address:</td>
                            <td>
                                <span><b>{{ $siteSettings->buisness_name ?? '' }}</b></span><br />
                                <i>Spaces Building</i><br />
                                <i>{{ $head_branch->address_line_1 . ' ' . $head_branch->address_line_2 }}</i><br>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 180px;">Directions:</td>
                            <td>
                                The entrance to the Spaces building is around the corner from Holland & Barrett (on
                                Old Broad Street; please ask for fone doctors at reception.
                            </td>
                            </ </tbody>
                </table>
            </div>
