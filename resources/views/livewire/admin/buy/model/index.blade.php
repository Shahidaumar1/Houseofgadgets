<div>
    <div class="d-flex">
        ...
        <x-content>
            <livewire:admin.buy.components.top-nav active="models" />
            <div class="container">
                ...
                <div class="d-flex align-items-center gap-4 justify-content-center my-4">
                    ...
                    @if ($target == 'Publish')
                        <button class="btn p-2" onclick="showM('add-buy-model')"
                ...
                @if ($activeView == 'card')
                    <div>
                            ...
                            @forelse($models as $model)
                                <div class="card  rounded-4 cursor-pointer">
                                    ...
                                    <div class="p-2 d-flex justify-content-between align-items-center">
                                        <small class = "text-center pt-2" style = "color: #20375E;"> Width: 800px
                                            Height: 800px</small>
                                    ...
                                    <div class="p-2 d-flex justify-content-center align-items-center">
                                        ...
                                        <a href="{{ route('buy-models-add-ons') }}" class="position-relative">
                                            <img src="{{ $model->file ?? '#' }}" class=""
                                                style="height: 100px; margin: 0px 62px;" />
                                        </a>
                                    </div>
                        ...
                        <div class="d-flex justify-content-center gap-4 flex-wrap pb-5 sortable-buy">
                            @forelse($models as $model)
                                <div class="card rounded-4 cursor-pointer" data-id="{{ $model->id }}">
                                    <div class="p-2 d-flex justify-content-between align-items-center">
                        ...
                        <script>
                            document.addEventListener('livewire:load', function() {
                                var el = document.querySelector('.sortable-buy');
    ...
    @if ($selectedDevice)
        <x-modal title="Add Model" id="add-buy-model">
            <livewire:admin.buy.model.create :device="$selectedDevice" />
        </x-modal>
    @endif

    <x-modal title="Edit Model" id="edit-buy-model">
        <livewire:admin.buy.model.edit />
    </x-modal>
