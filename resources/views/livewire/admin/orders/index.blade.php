                                    ...
                                    <td>
                                        <select class="form-select form-select-sm"
                                            ...
                                            <option value="approved" @selected($order->status=='approved')>Approved</option>
                                             <option value="repairing" @selected($order->status=='approved')>repairing</option>
                                 <option value="ready" @selected($order->status=='approved')>ready</option>
                                  <option value="completed" @selected($order->status=='approved')>completed</option>
                                <option value="collected" @selected($order->status=='approved')>collected</option>
