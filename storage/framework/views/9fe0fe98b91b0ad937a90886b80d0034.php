...
} elseif ($_instance->childHasBeenRendered('J0YXqk8')) {
    $componentId = $_instance->getRenderedChildComponentId('J0YXqk8');
    $componentTag = $_instance->getRenderedChildComponentTagName('J0YXqk8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('J0YXqk8');
} else {
    $response = \Livewire\Livewire::mount('guest.user-dashboard.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('J0YXqk8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
...
</div><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea\resources\views/frontend/Home_page_sections/formAndLocationSec.blade.php ENDPATH**/ ?>