...
<div class="hr-win" id="hrWin">
    <div class="hr-win-head">
        ...
        <div class="hr-head-info">
            <div class="hr-head-name"><?php echo e($chatBusinessName); ?> Assistant</div>
...
<!-- PHP → JS -->
<script>
var HR_WA_NUM    = '<?php echo e($chatWaNum); ?>';
var HR_BUSINESS  = '<?php echo e($chatBusinessName); ?>';
var HR_SITE_URL  = '<?php echo e($chatSiteUrl); ?>';
var HR_REPAIR_CATS = <?php echo json_encode($chatRepairCats, 15, 512) ?>;
</script>
...
</script><?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/frontend/partials/chatbot_dynamic.blade.php ENDPATH**/ ?>