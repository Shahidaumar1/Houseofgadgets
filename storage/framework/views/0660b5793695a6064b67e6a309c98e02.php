...
} elseif ($_instance->childHasBeenRendered('l2572732627-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2572732627-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2572732627-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2572732627-0');
} else {
    $response = \Livewire\Livewire::mount('components.logo', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2572732627-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <!-- Search Bar -->
...
} elseif ($_instance->childHasBeenRendered('l2572732627-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2572732627-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2572732627-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2572732627-1');
} else {
    $response = \Livewire\Livewire::mount('components.search-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2572732627-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
                <!-- btns -->
...
</div><?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/livewire/components/mega-nav.blade.php ENDPATH**/ ?>