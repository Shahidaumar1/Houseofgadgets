...
} elseif ($_instance->childHasBeenRendered('l1758886562-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1758886562-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1758886562-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1758886562-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', ['theme' => 'white']);
    $html = $response->html();
    $_instance->logRenderedChild('l1758886562-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <section class="repair-type-page">
            <div class="cust-container">
                ...
                <div class="repair-main-sec">
                    ...
                    <h2>Broken <?php echo e($modal->name ?? ''); ?></h2>
                    <?php if($device): ?>
                    <div class="repair-main-inner">
                       ...
                       <div class="repair-item-box" data-url="<?php echo e($repairUrl); ?>">
    <figure>
        <img src="<?php echo e(asset($repair_type->image) ?? ''); ?>"
            alt="<?php echo e(asset($repair_type->image) ?? ''); ?>" class="img-fluid">
    </figure>
    <div style="text-align:left;">
        <h4> <?php echo e($repair_type->name); ?></h4>
        <h6>£ <?php echo e($price->price); ?></h6>
    </div><br>
    <a class="repair-btn" href="<?php echo e($repairUrl); ?>">
        Book Instant Repair 
    </a>
    <a class="mobile-repair-btn" href="<?php echo e($repairUrl); ?>">
...
</script><?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/livewire/guest/repair-types.blade.php ENDPATH**/ ?>