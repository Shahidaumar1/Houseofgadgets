...
} elseif ($_instance->childHasBeenRendered('otjP0oU')) {
    $componentId = $_instance->getRenderedChildComponentId('otjP0oU');
    $componentTag = $_instance->getRenderedChildComponentTagName('otjP0oU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('otjP0oU');
} else {
    $response = \Livewire\Livewire::mount('hero-slider', ['placement' => 'home_hero','limit' => 4]);
    $html = $response->html();
    $_instance->logRenderedChild('otjP0oU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/frontend/Home_page_sections/banner.blade.php ENDPATH**/ ?>