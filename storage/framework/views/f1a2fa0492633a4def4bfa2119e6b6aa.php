        ...
        <div class="row pb-4 pb-md-5">
          <div class="col-sm-6 col-lg-3 col-xl-4">
            <div class="footer-logo-box">
              ...
              <a href="/"><h4><?php echo e($siteSettings->buisness_name ?? ($head_branch->name ?? 'Website')); ?></h4></a>
              <p>Your <?php echo e($brand); ?> partners in UK. Welcome to <?php echo e($brand); ?></p>
        ...
        <div class="row pb-4">
          <div class="col-sm-6 col-lg-3">
            <div class="footer-box">
              ...
              <ul class="footer-panel">
                <?php if($formStatuses->repair ?? false): ?>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="footer-box">
              ...
              <ul class="footer-panel">
                <li><a href="<?php echo e(route('terms-and-conditions')); ?>" class="footer-link">Terms & Conditions</a></li>
                <li><a href="<?php echo e(route('privacy-and-policy')); ?>" class="footer-link">Privacy Policy</a></li>
            ...
            <div class="footer-box">
              ...
              <ul class="footer-panel">
                ...
                <li>
                  ...
                  <a href="<?php echo e($siteSettings->google_map_profile_link); ?>" target="_blank" class="footer-link">
                    <?php echo e(($head_branch->address_line_1 ?? '') . ' ' . ($head_branch->address_line_2 ?? '')); ?>
      ...
      <div class="px-2 px-sm-3">
        <div class="custom-container">
          <div class="copy-write-content single-line">
            <p class="mb-0">Copyright © <?php echo e(date('Y')); ?> <?php echo e($brand); ?> - All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </div>
...
<?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/frontend/sections/footer.blade.php ENDPATH**/ ?>