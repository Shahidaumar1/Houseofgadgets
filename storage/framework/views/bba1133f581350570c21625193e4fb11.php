...
} elseif ($_instance->childHasBeenRendered('l1067485279-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1067485279-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1067485279-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1067485279-0');
} else {
    $response = \Livewire\Livewire::mount('components.top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1067485279-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  <?php
...
} elseif ($_instance->childHasBeenRendered('l1067485279-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1067485279-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1067485279-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1067485279-1');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1067485279-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  ...
  <section class="device-type-head">
    <div class="cust-container">
      <div class="device-type-heading">
        <p>
          <?php echo $webContent->repair_page_heading_1; ?>

          <?php echo $webContent->repair_page_heading_2; ?>
  ...
  <div class="custom-deviceType-page">
    <div class="cust-container">
      <div class="device-type-section">
        <h3><?php echo $webContent->repair_page_heading_3; ?></h3>

        <div class="device-type-items">
          <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php if($category->name != 'Apple iPad'): ?>
              <div class="deviceType-box" style="cursor:pointer;" onclick="window.location='<?php echo e(route('device-types', $category->slug)); ?>'">
                <figure>
                  <img src="<?php echo e($category->file ?? ''); ?>" alt="feature image">
                </figure>
...
<?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/livewire/guest/categories.blade.php ENDPATH**/ ?>