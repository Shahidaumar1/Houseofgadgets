...
} elseif ($_instance->childHasBeenRendered('YyUgdab')) {
    $componentId = $_instance->getRenderedChildComponentId('YyUgdab');
    $componentTag = $_instance->getRenderedChildComponentTagName('YyUgdab');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YyUgdab');
} else {
    $response = \Livewire\Livewire::mount('components.top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('YyUgdab', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>  
        <?php
...
} elseif ($_instance->childHasBeenRendered('wEPUGH5')) {
    $componentId = $_instance->getRenderedChildComponentId('wEPUGH5');
    $componentTag = $_instance->getRenderedChildComponentTagName('wEPUGH5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wEPUGH5');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('wEPUGH5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea\resources\views/home.blade.php ENDPATH**/ ?>