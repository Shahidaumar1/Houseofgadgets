...
} elseif ($_instance->childHasBeenRendered('l4198711635-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4198711635-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4198711635-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4198711635-0');
} else {
    $response = \Livewire\Livewire::mount('components.top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4198711635-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  <?php
...
} elseif ($_instance->childHasBeenRendered('l4198711635-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4198711635-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4198711635-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4198711635-1');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4198711635-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea\resources\views/livewire/guest/categories.blade.php ENDPATH**/ ?>