    ...
    <div class="custom-container">
      <div class="custom-sec2-main">
        ...
        <div class="row custom-sec2-inner justify-content-center">
          <?php $__empty_1 = true; $__currentLoopData = $homeDeviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-sm-6 col-md-6" data-url="<?php echo e(url('/device-types/'.$device->id)); ?>">
              <div class="custom-sec2-box">
                <figure>
                  <img src="<?php echo e($device->file ?: 'https://via.placeholder.com/360x260?text=Device'); ?>"
                       alt="<?php echo e($device->name); ?>" class="img-fluid"
                       width="360" height="260" loading="lazy">
                </figure>
                <a href="<?php echo e(url('/device-types/'.$device->id)); ?>">
...
<?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/frontend/Home_page_sections/devicesAndBrandsSection.blade.php ENDPATH**/ ?>