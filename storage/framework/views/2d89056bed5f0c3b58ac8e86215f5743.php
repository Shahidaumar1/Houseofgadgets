...
} elseif ($_instance->childHasBeenRendered('l2327471384-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2327471384-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2327471384-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2327471384-0');
} else {
    $response = \Livewire\Livewire::mount('components.top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2327471384-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  <?php
...
} elseif ($_instance->childHasBeenRendered('l2327471384-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2327471384-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2327471384-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2327471384-1');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2327471384-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
.deviceBrand-box span {
 ...
 .deviceBrand-box span:hover{
  ...
  <?php $__currentLoopData = $C; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <a class="brand-link" href="<?php echo e(route('modals', ['category' => $category->slug, 'device' => $device_type->slug])); ?>">
      <div class="deviceBrand-box">
        <figure>
          <img src="<?php echo e($device_type->file ?? ''); ?>" alt="<?php echo e($device_type->name); ?>">
        </figure>
        <!-- Brand name below the image -->
        <span class="brand-name"><?php echo e($device_type->name); ?></span>
      </div>
    </a>
  ...
  <section class="cust-container px-3 pb-md-4">
    <div class="row">
      <div class="col-md-12 mb-5 d-flex justify-content-center">
        <a href="<?php echo e($reviewUrl); ?>" target="_blank" rel="noopener">
          <button type="button" class="btn myreviewbtn">
            Review us  &nbsp;
            <strong class="me-1"><?php echo e(number_format($rounded, 1)); ?></strong>
            ...
            <?php if($reviewCnt>0): ?>
              <span class="ms-2">(<?php echo e($reviewCnt); ?>)</span>
            <?php endif; ?>
  ...
  document.addEventListener('DOMContentLoaded', function(){
    document.getElementById('globalBackBtn')?.addEventListener('click', function(e){
      ...
      if (document.referrer && document.referrer.startsWith(location.origin)) {
        ...
        window.location.href = "<?php echo e(route('categories')); ?>";
      }
    });
  });
</script>
<?php /**PATH /home/thephonelab/houseofgadgets.thephonelab.co.uk/resources/views/livewire/guest/device-typs.blade.php ENDPATH**/ ?>